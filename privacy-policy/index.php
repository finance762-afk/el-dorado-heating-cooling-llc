...
<main id="main-content">
  ...
  <article class="legal-prose">
    ...
    <ul>
      <li>Respond to inquiries and provide requested HVAC services</li>
      <li>Schedule estimates, service appointments, and HVAC work</li>
    ...
    <ul>
      ...
      <li><strong>Service providers:</strong> Google Analytics (analytics), our hosting provider, and Page One Insights, LLC (our web design partner — receives copies of contact form submissions via database leads endpoint for lead-tracking purposes).</li>
      <li><strong>Subcontractors and material suppliers:</strong> as necessary to complete your HVAC project.</li>
    ...
    <p><strong>How to exercise your rights:</strong> Email <a href="mailto:<?php echo $email; ?>"><?php echo $email; ?></a> or call <a href="tel:<?php echo $phoneTel; ?>"><?php echo $phone; ?></a>. We will respond within 45 days of receipt.</p>
    ...
    <p>When you submit our contact form and check the consent box, you agree to receive phone calls and SMS text messages from us about your HVAC service request. Standard message and data rates may apply. Consent is not a condition of purchase. You can opt out of SMS communications at any time by replying STOP to any text message. You can opt out of phone communications at any time by telling our representative or emailing us at <a href="mailto:<?php echo $email; ?>"><?php echo $email; ?></a>.</p>

    <h2>7. Data Retention</h2>
    <p>We retain contact form submissions and service records for as long as necessary to provide services and comply with legal obligations, typically 5–7 years for business and warranty records.</p>
